...
// Интерфейс Employee определяет методы для назначения навыка и выполнения задачи
interface Employee
{
...
// Класс Tester реализует интерфейс Employee и представляет собой тестировщика
...
// Класс EmployeeFactory отвечает за создание и управление объектами Employee
